...
_BEHAVIOR_DISPLAY = {
    ...
    "true_damage": ("纯粹伤害", "以纯粹伤害绕开常规护甲。", ("虚空", "纯粹", "湮灭", "无视")),
    ...
    "resource_drain": ("同步汲取", "抽取目标同步并恢复自身。", ("截流", "枯竭", "吸能", "断联")),
    ...
    "counter": ("镜返", "主动执行镜像斩击协议。", ("荆棘", "反刃", "复仇", "回击")),
    ...
    "stun": ("震荡失能", "尝试对目标施加震荡失能。", ("震荡", "雷击", "昏迷", "重震")),
    "freeze": ("冻结锁定", "尝试对目标施加冻结锁定。", ("霜缚", "冰封", "永冻", "寒潮")),
    "sleep": ("休眠侵入", "尝试对目标施加休眠侵入。", ("梦雾", "沉眠", "迷梦", "梦魇")),
