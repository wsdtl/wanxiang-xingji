...
_FAMILY_DISPLAY = {
    ...
    "star_array": ("天环阵列", "依据天环轨道校准的阵列兵装型制。"),
...
_PROPERTY_DISPLAY = {
    ...
    "tenacity": ("坚韧", "缩短受到的控制"),
    "vital_guard": ("刚毅", "同时提高生命上限和防御"),
    "spirit_step": ("同步流转", "同时提高同步上限和速度"),
...
_SET_DISPLAY = {
    ...
    "frost_prison": ("斯卡蒂零温套装", "控制与寒霜协同"),
    "starfall": ("开普勒轨道套装", "命中与暴击协同"),
    "sky_burn": ("普罗米修斯赤炉套装", "火焰与增伤协同"),
    "void_realm": ("厄瑞玻斯暗环套装", "穿盾与纯粹伤害回响协同"),
